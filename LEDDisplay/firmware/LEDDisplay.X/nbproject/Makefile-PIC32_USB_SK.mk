...
${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o: ../src/system_config/PIC32_USB_SK/framework/driver/spi/dynamic/drv_spi_tasks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -Os -DUSE_CUSTOM_DRV_SPI_INTERNAL_H -I".." -I"../src" -I"../src/system_config/PIC32_USB_SK" -I"../../../../../microchip/harmony/v1_06/framework" -I"../src/system_config/PIC32_USB_SK/framework" -I"../../../../../microchip/harmony/v1_06/bsp/pic32mx_usb_sk2" -MMD -MF "${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o.d" -o ${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o ../src/system_config/PIC32_USB_SK/framework/driver/spi/dynamic/drv_spi_tasks.c   
...
${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o: ../src/system_config/PIC32_USB_SK/framework/driver/spi/dynamic/drv_spi_tasks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o.d 
	@${RM} ${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -Os -DUSE_CUSTOM_DRV_SPI_INTERNAL_H -I".." -I"../src" -I"../src/system_config/PIC32_USB_SK" -I"../../../../../microchip/harmony/v1_06/framework" -I"../src/system_config/PIC32_USB_SK/framework" -I"../../../../../microchip/harmony/v1_06/bsp/pic32mx_usb_sk2" -MMD -MF "${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o.d" -o ${OBJECTDIR}/_ext/1866559691/drv_spi_tasks.o ../src/system_config/PIC32_USB_SK/framework/driver/spi/dynamic/drv_spi_tasks.c   
...
dist/${CND_CONF}/${IMAGE_TYPE}/LEDDisplay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../../../microchip/harmony/v1_06/bin/framework/peripheral/PIC32MX795F512L_peripherals.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/LEDDisplay.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ..\..\..\..\..\microchip\harmony\v1_06\bin\framework\peripheral\PIC32MX795F512L_peripherals.a      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=0,--gc-sections,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
