...
#define _DRV_SPI_INTERNAL_H_
    ...
    #include "c:/microchip/harmony/v1_06/framework/driver/spi/src/dynamic/drv_spi_internal.h"
    #warning "Not Using custom drv_spi_internal.h"
#else
...
////#include <driver/spi/drv_spi.h>
////#include <osal/osal.h>
//#include "c:/microchip/harmony/v1_06/framework/driver/spi/src/drv_spi_sys_queue.h"
////#include <driver/spi/src/drv_spi_sys_queue.h>
...
/******************************************************************************/
/* this is changed from the original size in Harmony.                         */
