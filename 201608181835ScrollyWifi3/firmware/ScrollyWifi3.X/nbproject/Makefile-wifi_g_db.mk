...
${OBJECTDIR}/_ext/793058988/drv_spi_tasks.o: ../src/system_config/wifi_g_db/framework/driver/spi/dynamic/drv_spi_tasks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/793058988/drv_spi_tasks.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -DPLIB_INLINE="static inline" -DPLIB_INLINE_API="static inline" -DUSE_CUSTOM_DRV_SPI_INTERNAL_H -I"../../../" -I"../src" -I"../src/system_config/wifi_g_db" -I"../src/system_config/wifi_g_db/framework" -I"../../../../../microchip/harmony/v1_06_02/framework" -I"../../../../../microchip/harmony/v1_06_02/bsp/wifi_g_db" -Wall -MMD -MF "${OBJECTDIR}/_ext/793058988/drv_spi_tasks.o.d" -o ${OBJECTDIR}/_ext/793058988/drv_spi_tasks.o ../src/system_config/wifi_g_db/framework/driver/spi/dynamic/drv_spi_tasks.c     
